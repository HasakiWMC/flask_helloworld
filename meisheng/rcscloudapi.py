...
class RCSCLOUDAPI:
    ...
    #短信帐号
    __ACCOUNT_SID = "ZH000000565"
 
    #通讯认证Key
    __ACCOUNT_APIKEY = "54cc3c64-a5f9-4961-89aa-07a19bf8d936"
    ...
    def sendTplSms(self,templateId, mobile, content, extno=""):
        ...
        #请求参数
        paras={"sid":self.__ACCOUNT_SID,"sign":sign,"tplid":templateId,"mobile":mobile,"content":content,"extno":extno}
